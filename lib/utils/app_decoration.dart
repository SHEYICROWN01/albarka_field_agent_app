...
class AppDecoration {
  ...
  static BoxDecoration get fillGray30087 => BoxDecoration(
  ...
  static BoxDecoration get fillDeeporange800 => BoxDecoration(
    color: ColorConstant.primaryColor,
  );
  static BoxDecoration get txtFillWhiteA700 => BoxDecoration(
    color: ColorConstant.whiteA700,
  );
  static BoxDecoration get fillGray30075 => BoxDecoration(
    color: ColorConstant.gray30075,
  );
}
...
class BorderRadiusStyle {
  ...
  static BorderRadius roundedBorder59 = BorderRadius.circular(
    getHorizontalSize(
      59.77,
    ),
  );
