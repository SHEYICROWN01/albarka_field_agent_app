...
import 'package:albarka_agent_app/controller/auth_provider/auth_repositoy.dart';
...
class _DailyExpensesState extends State<DailyExpenses> {
  ...
  Future<void> uploadExpenses() async {
    ...
    try {
      ...
      final url = Uri.parse('https://dashboard.albarkaltd.com/albarkaAPI/dailyExpenses.php');
  ...
  Future<void> getMethod() async {
    final agentId = Provider.of<AuthViewModel>(context, listen: false);
    var url = Uri.parse('https://dashboard.albarkaltd.com/albarkaAPI/getDailyExpenses.php?agentId=${agentId.userid}');
