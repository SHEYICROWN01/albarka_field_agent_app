...
class _NoteViewState extends State<NoteView> {
  ...
  Future uploadComment() async {
    ...
    try {
      ...
      final url = Uri.parse(
          'https://dashboard.albarkaltd.com/mobileapi/individualComment.php');
  ...
  getMethod() async {
    final agentId = Provider.of<AuthViewModel>(context, listen: false);
    var url = Uri.parse(
        "https://dashboard.albarkaltd.com/mobileapi/getIndividualComment.php?agentId=${agentId.userid}");
