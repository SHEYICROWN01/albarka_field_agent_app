...
class _UpdateProfileState extends State<UpdateProfile> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      _list.clear();
      var url = Uri.parse('https://dashboard.albarkaltd.com/mobileapi/getMemberForUpdate.php');
      final response = await http.post(url);

      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
        _list = data.map<UpdateModel>((json) => UpdateModel.fromJson(json)).toList();
      }
              ...
              child: ListTile(
                ...
                leading: CircleAvatar(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      'https://dashboard.albarkaltd.com/${itemList[i].picture}',
                      fit: BoxFit.cover,
                      width: 70,
                      height: 70,
                    ),
